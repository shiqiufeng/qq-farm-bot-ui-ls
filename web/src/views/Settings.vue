    ...
    <div v-else class="grid grid-cols-1 gap-4 text-sm lg:grid-cols-2">
      ...
      <div v-if="currentAccountId" class="card h-full flex flex-col rounded-lg bg-white shadow dark:bg-gray-800">
        ...
        <div class="p-4 space-y-4">
          ...
          <div class="border border-purple-200 rounded-lg bg-purple-50/70 p-3 dark:border-purple-500/50 dark:bg-purple-900/20">
            <div class="flex flex-wrap items-center gap-4">
              <BaseSwitch v-model="localSettings.automation.organicAntiSteal" label="有机肥防偷菜" />
              <BaseInput
                v-if="localSettings.automation.organicAntiSteal"
